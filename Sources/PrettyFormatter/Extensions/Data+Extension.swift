...
extension Data {
    ...
    /// If any of these steps fail, it returns the error message string.
    ///
    /// - Returns: A `String` containing the prettified JSON representation, or error message if the process fails.
    public var prettyFormatted: String {
        guard
            ...
            return PrettyFormatterError.couldNotFormatToJSON.errorDescription
        }
